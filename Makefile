...
#    Updated: 2024/11/15 12:23:12 by marcsilv         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LRFLAGS		= -lreadline
OBJS		= $(SRCS:.c=.o)
SRCS		= ./utils/env/expand.c ./utils/env/convert_env.c ./utils/parse_utils/utils.c ./split/split_input_ext.c ./split/split_input.c minishell.c
HEADER		= minishell.h
